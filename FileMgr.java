...
public class FileMgr { 
   ...
   static int numofBlockRead = 0;
   static int numofBlockWrite = 0;
   ...
   public static void getFileStatistics(){
	   System.out.println("number of block reads = " + numofBlockRead);
	   System.out.println("number of block writes = " + numofBlockWrite);
